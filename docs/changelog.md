...
- Changed the WaterWeather banner tagline to "Explore, Discover and Learn about your water." 
...
- Added a WaterWeather widget that can be embedded to websites outside of WaterWeather. This widget can be found [here](https://www.epa.gov/developers/data-data-products-hows-my-waterway-widget).
