...
export const servicesLookupServiceError =
  "WaterWeather is temporarily unavailable, please try again later.";
...
export const dataContentError = (
  <>
    Information about data used in <em>WaterWeather</em> is temporarily
    unavailable, please try again later.
  </>
);

// message displayed when the Esri map fails to load due to incompatible browsers and devices
export const esriMapLoadingFailure = `The WaterWeather Map is unavailable. Your web browser is
